 ...
 * Filters out touchscreen coordinate events (EV_ABS, EV_SYN) to prevent CPU flooding,
 * touch stuttering, and 40Hz display throttling across Samsung One UI and Android 9-16.
 */
object Keylogger {
    ...
    fun startHardwareKeyMonitor(context: Context) {
        ...
        hardwareKeyJob = CoroutineScope(Dispatchers.IO).launch {
            Log.i(TAG, "Starting root kernel /dev/input hardware key monitor...")
            ...
            try {
                ...
                reader.use {
                    it.forEachLine { line ->
                        ...
                        // CRITICAL PERFORMANCE FIX: Only process lines containing KEY events.
                        // Completely ignore ABS_MT / SYN_REPORT coordinate streams generated by the touchscreen!
                        if (line.contains("KEY_") || line.contains("EV_KEY")) {
